...
export function GameView({game, onClick, selected }: GameProps) {
    return (
        <div className={`flex flex-row items-center gap-x-4 px-2 py-2 bg-mocha-base border-mocha-base border rounded-sm text-mocha-text ${selected ? "border-mocha-mauve bg-mocha-mauve/20" : ""} hover:border-mocha-mauve transition-all hover:cursor-pointer`} onClick={onClick}>
            ...
            <div className="px-10 py-8 h-full flex flex-col overflow-hidden">
                ...
                <div className="flex flex-row flex-1 min-h-0 w-full pr">
                    ...
                    <div className="flex flex-col min-w-1/3 max-w-1/3 gap-y-4 overflow-x-hidden">
                        <div className="flex items-center gap-2 px-4 bg-mocha-base max-w-full rounded-sm">
                        ...
                        <div className="flex flex-col gap-y-2 overflow-y-auto pr-4">
                            {supportedGames.filter((game) => game.name.toLowerCase().includes(searchQuery) || game.executables.filter((exe) => exe.toLowerCase().includes(searchQuery)).length > 0).map((game) => (
                                <GameView
                                    game={game}
                                    selected={chosenGame != null && chosenGame == game}
                                    onClick={() => {
                                        setChosenGame(game);
                        ...
                        <div className="flex flex-col min-w-2/3 max-w-2/3 text-mocha-text px-6 py-4 gap-y-4 overflow-y-auto ml-4 bg-mocha-base/20 rounded-xl">
                            <div className="flex flex-row items-center justify-between">
                                <div className="flex flex-row items-center gap-x-4 text-mocha-text">
                                    <img className="w-8 h-8" src={modifiedGame.icon ?? ""}/>
                                    <p className="text-lg font-semibold">{modifiedGame.name}</p>
                                </div>
                            ...
                            <section className="flex flex-col gap-4">
                                <h3 className="text-xs font-medium text-mocha-overlay2 uppercase tracking-wider">INFO</h3>
                                <SettingsContainer title="Name" description="The name of the game">
                                    <Input
                                ...
                                <SettingsContainer title="Icon" description="URL to the icon">
                                    <Input
                                        className="bg-mocha-mantle"
                                        type="text"
                            ...
                            <section className="flex flex-col gap-4">
                                <h3 className="text-xs font-medium text-mocha-overlay2 uppercase tracking-wider">DETECTION</h3>
                                    ...
                                    <div className="flex flex-row justify-between">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-xs text-mocha-overlay1">
                                                Processes used to detect the running game
                                            </span>
                                        ...
                                        {modifiedGame.executables.map((exe, index) => (
                                            <div key={index} className="flex items-center gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    value={exe}
                                                    onChange={(value) => {
                                                        const updated = [...modifiedGame.executables];
                                                        updated[index] = value;
                                                        updateField("executables", updated);
                                                    }}
                                                />
                                ...
                                <div className="flex flex-col gap-4 p-4 rounded-lg bg-mocha-base">
                                    <div className="flex flex-row justify-between">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-xs text-mocha-overlay1">
                                                Regex patterns used to match window titles
                                            </span>
                                        </div>
                                        ...
                                        {modifiedGame.title_regex.map((regex, index) => (
                                            <div key={index} className="flex items-center gap-2">
                                                ...
                                                <Input
                                                    ...
                                                    value={regex}
                                                    onChange={(value) => {
                                                        const updated = [...modifiedGame.title_regex];
                                                        updated[index] = value;
                                                        updateField("title_regex", updated);
                                                    }}
                                                />
                            ...
                            <section className="flex flex-col gap-4">
                                <h3 className="text-xs font-medium text-mocha-overlay2 uppercase tracking-wider">COMPATIBILITY</h3>
