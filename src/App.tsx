...
export default function App() {
    ...
    return (
        <div className="flex flex-row h-screen w-screen relative">
            ...
            {/* avoid tab rerendering */}
            <div
                className={currentTab === Tab.Clips ? "w-full block" : "hidden"}
            >
                <ClipTab />
            </div>

            <div
                className={currentTab === Tab.Games ? "w-full block" : "hidden"}
            >
                <GameTab />
            </div>
            ...
            <div
                className={
                    currentTab === Tab.Settings ? "w-full block" : "hidden"
                }
            >
                <SettingTab />
            </div>
