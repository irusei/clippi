    ...
    <div className="relative flex flex-col w-full h-screen overflow-hidden text-mocha-text bg-mocha-base font-sans">
      ...
      <div className="relative flex items-center justify-center flex-1 bg-mocha-crust overflow-hidden">
        <video
          ...
          onClick={togglePlay}
          onTimeUpdate={() =>
            playerRef.current && setCurrentTime(playerRef.current.currentTime)
          }
        />
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 group">
                {volume == 0 ? (
                  ...
                  <Volume2 onClick={mute} className="w-5 h-5 cursor-pointer" />
                )}
                <input
                  type="range"
                  min="0"
          ...
          <div className="flex flex-col">
            {clip.action_count.length > 0 && (
              <p className="text-mocha-text font-semibold">
                APM:{" "}
                {(
                  (clip.action_count.reduce((totalSum, cur) => totalSum + cur) /
